...
- [ ] Remote vector lane trên Colab chưa được validate end-to-end.
...
- [x] Phase 0 contract and mock surface completed
...
- [x] Xây BM25 index.
- [ ] Xây vector index bằng `mainguyen9/vietlegal-harrier-0.6b` và validate remote Colab lane.
...
| --- | --- | --- | --- | --- |
| Lane A | Data and Retrieval | Data/RAG engineer | Planned | Ready after contract freeze |
